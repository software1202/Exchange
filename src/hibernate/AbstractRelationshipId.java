...
/**
 * AbstractRelationshipId entity provides the base persistence definition of the
 * RelationshipId entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractRelationshipId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractRelationshipId() {
	}

	/** full constructor */
	public AbstractRelationshipId(User user, User user_1) {
		this.user = user;
		this.user_1 = user_1;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AbstractRelationshipId))
			return false;
		AbstractRelationshipId castOther = (AbstractRelationshipId) other;
