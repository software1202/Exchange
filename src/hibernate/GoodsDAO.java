...
public class GoodsDAO extends BaseHibernateDAO {
	...
	public Goods findById(java.lang.String id) {
		...
		try {
			Goods instance = (Goods) getSession().get("hibernate.Goods", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Goods instance) {
		...
		try {
			List results = getSession().createCriteria("hibernate.Goods")
	...
	public List findByNewDegree(Object newDegree) {
		return findByProperty(NEW_DEGREE, newDegree);
	}
